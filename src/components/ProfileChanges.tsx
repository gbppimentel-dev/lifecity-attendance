...
function EditorBody({onProfileChanged}:{onProfileChanged:()=>void}){
 ...
 return <section className="lpe-editor" aria-label="Edit Your Profile">
  <div className="lpe-heading"><div><h3>Keep Your Profile Up to Date</h3><p>Mobile changes save directly. Other changes go to the Owner for approval.</p></div><button className="lpe-button" disabled={saving||loading} onClick={()=>setRevision(v=>v+1)}><RefreshCw size={14}/>Reload Editor</button></div>
