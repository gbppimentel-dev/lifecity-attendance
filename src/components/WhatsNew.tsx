...
export default function WhatsNew(){
 const [latest,...history]=releaseNotes
 return <section className="lc-whats-new" aria-label="What’s New in LifeCity Attendance">
  <header><div><p className="eyebrow">LifeCity Attendance · Still Growing</p><h2><Sparkles size={22}/>What’s New</h2></div><span className="lcf-ticket-status reviewing">Pre-Launch · Before v1.0</span></header>
