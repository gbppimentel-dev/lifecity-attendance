...
export default function FeedbackWidget(){
 ...
 <label className="lcf-anonymous"><input type="checkbox" checked={anonymous} onChange={e=>setAnonymous(e.target.checked)} aria-describedby={`${id}-privacy`}/><span><strong>Hide My Identity</strong><small id={`${id}-privacy`}>Admins would not be able to see the source of the feedback.</small></span></label>
 </fieldset>
