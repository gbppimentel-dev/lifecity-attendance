...
export default function AppearanceSettings(){
 ...
 </fieldset><div className="lc-preview-column"><div className="lc-preview-caption"><strong>Live Preview</strong><span>Try the buttons, search, and export panel.</span></div><PalettePreview tokens={draft} active={active} label={titleLabel(selected[2])}/><p className="lc-preview-note">Preview only. Saving applies these colors across the app. Camera video and member QR codes keep their original colors.</p></div></div>
 </>}
